    ...
    <div className="m-auto my-16 rounded-xl w-[30%]" style={{boxShadow: "10px 10px 50px 0px rgba(0,0,0,0.32)"}}>
        <div className="flex flex-col items-center space-y-8 text-gray-600 py-16">
            <div className="space-y-2 text-left">
                <h1 className="text-[20pt] font-medium">Login</h1>
                <p className="text-[11pt]">Please log in to book an appointment</p>
            </div>
            ...
            <button className="rounded-lg bg-[#5f6fff] text-white px-[18%] py-3 font-medium text-[14pt]">Login</button>

            <p>Don't have an account? <Link to={'/signup'}><b className="hover:underline cursor-pointer">Register here</b></Link></p>
        </div>
    </div>
    </>
  )
